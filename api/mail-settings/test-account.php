...
try {
    ...
    $mail->Subject = 'Jebal Guest House mail connection test';
    $mail->Body = 'This message confirms that the Office 365 mail account is connected to the Jebal Guest House admin system.';
    $mail->send();
