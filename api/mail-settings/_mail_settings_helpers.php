...
function ensure_mail_settings_tables(PDO $pdo): void
{
    ...
    $defaults = [
        'booking' => [defined('BOOKING_ADMIN_EMAIL') ? BOOKING_ADMIN_EMAIL : 'bookings@jebalguesthouse.com', 1, 1],
        'payment' => [defined('BOOKING_ADMIN_EMAIL') ? BOOKING_ADMIN_EMAIL : 'bookings@jebalguesthouse.com', 1, 1],
        'contact' => [defined('CONTACT_ADMIN_EMAIL') ? CONTACT_ADMIN_EMAIL : 'info@jebalguesthouse.com', 1, 1],
        'contact_auto_reply' => [null, 1, 0],
        'stay_reminder' => [defined('ADMIN_EMAIL') ? ADMIN_EMAIL : 'admin@jebalguesthouse.com', 1, 0],
        'admin_alert' => [defined('ADMIN_EMAIL') ? ADMIN_EMAIL : 'admin@jebalguesthouse.com', 0, 1],
